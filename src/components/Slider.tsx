  ...
  return (
    <div className=' flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] lg:flex-row bg-fuchsia-50' >
      ...
      <div className='h-1/2 flex items-center justify-center flex-col gap-8 text-red-500 font-bold lg:h-full lg:w-1/2'>
        <h1 className='text-5xl text-center uppercase p-4 md:text-6xl lx:text-7xl md:p-10'>
          {data[currentSlide].title}
        </h1>
        <Link className='bg-red-500 text-white py-4 px-8 rounded-md' href="/orders">Order Now</Link>
      </div>
      {/* IMAGE CONTAINER */}
